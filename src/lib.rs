...
pub mod prelude {
    ...
    pub const STATUS_EFFECT_MIGHT_DAMAGE_BOOST: i32 = 4;
    pub const STATUS_EFFECT_PROTECTION_DEFENSE_BOOST: i32 = 4;
    pub const STATUS_EFFECT_WEAKNESS_DAMAGE_REDUCTION: i32 = 4;
